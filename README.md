...
4.21,18:28,重大版本更新，更换了SDK版本，添加了数个UI库，YouKou完成了车票搜索逻辑，Jrggwsy完成了车票显示逻辑
    ...
    3.UI显示存在问题
----
<img src="https://github.com/Jrggwsy/fast-dev-tickit-order/blob/master/demo.gif" width="480" height="7200" alt="图片加载失败"/>
![现阶段Demo](https://github.com/Jrggwsy/fast-dev-tickit-order/blob/master/demo.gif)